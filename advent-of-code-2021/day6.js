...
you make some guesses about their attributes. Surely, each lanternfish creates a
...
The new lanternfish starts with an internal timer of 8 and does not start counting
...
has an internal timer of 4, and so on until the fifth fish, which has an internaltimer of 2.
...
Expected output: 1595330616005


*/

/*
Resolution based on: https://github.com/adarsh0d/advent-of-code-2021/blob/master/day6/day6.js
*/
...
fs.readFile('day6-input.txt', 'utf-8', (err, s) => {
    s.split(',').map(Number).forEach((n) => {
        fishes[n] += 1;
      });
    console.log(fishes);
    console.log(noOfFish(fishes, 80)); /*part 1 */
    console.log(noOfFish(fishes, 256)); /*part 2 */
})
