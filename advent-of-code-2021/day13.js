...
The second value, y, increases downward. So, the coordinate 3,0 is
to the right of 0,0, and the coordinate 0,7 is below 0,0.
...
Each instruction indicates a line on the transparent paper and wants you
...
Because the paper is transparent, the dot just below them in the result (at 0,3)
...
Expected output: AHPRPAUZ
*/

// Results based on: https://github.com/constb/aoc2021/blob/master/13/index.js

// Part 1
let data = require("fs").readFileSync("day13-input.txt", { encoding: "utf-8" }).trim();
