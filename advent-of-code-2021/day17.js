...
the probe must be on some trajectory that causes it to be within a target
area after any step. The submarine computer has already calculated this target
...
you need to find every initial velocity that causes the probe to eventually be
...
Expected output: 5247
*/

//Resolution based on: https://github.com/tpatel/advent-of-code-2021/blob/main/day17.js
// video explanation no audio: https://youtu.be/MTTnnqXVIso

const fs = require("fs");

const line = fs
  .readFileSync("day17-input.txt", { encoding: "utf-8" }) // read day??.txt content
  .trim();
