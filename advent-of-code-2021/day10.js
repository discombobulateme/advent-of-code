...
that is, where the characters it opens and closes with do not form one of the four
...
high score for syntax errors in a file? It's true!
...
Expected output: 315693

--- Part Two ---
Now, discard the corrupted lines. The remaining lines are incomplete.

Incomplete lines don't have any incorrect characters - instead, they're missing
some closing characters at the end of the line.
To repair the navigation subsystem, you just need to figure out the sequence of
...
In this example, the middle score is 288957 because there are the same number of
...
Expected output: 1870887234
*/

//Resulution based on: https://github.com/llun/advent-of-code-2021/blob/main/day10/syntax.js
/*
const fs = require("fs");
...
console.log("Part1");
console.log(part1(getInput("./day10-input.txt")));
...
console.log("Part2");
console.log(part2(getInput("./day10-input.txt")));
*/

//Resolution based on: https://github.com/TheAngularGuy/aoc2021/blob/master/day10/part1.js
const fs = require('fs');
