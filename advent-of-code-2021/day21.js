...
the die three times and adds up the results.
Then, the player moves their pawn that many times forward around the
track (that is, moving clockwise on spaces in order of increasing value,
wrapping back around to 1 after 10).
So, if a player is on space 7 and they roll 2, 2, and 1,
they would move forward 5 times, to spaces 8, 9, 10, 1,
...
the score of the losing player by the number of times the die was
rolled during the game?

Expected output: 679329
*/

//Part 1: https://github.com/constb/aoc2021/blob/master/21/index.js

let test = false;
let p1 = test ? 4 : 7; /* Player 1 starting position: 7 (my advent input) */
let p2 = test ? 8 : 9; /* Player 2 starting position: 9 (my advent input) */
