...
Each octopus slowly gains energy over time and flashes brightly for a moment when
its energy is full. Although your lights are off, maybe you could navigate through
the cave without disturbing the octopuses if you could predict when the flashes of light will happen.
...
Here, the top-left octopus has an energy level of 5, the bottom-right one has
an energy level of 6, and so on.
...
that are diagonally adjacent. If this causes an octopus to have an energy level
greater than 9, it also flashes. This process continues as long as new octopuses
...
//Resolution based on: https://github.com/llun/advent-of-code-2021/blob/main/day11/flashes.js
const fs = require("fs");
...
console.log("Part1");
console.log(part1(getInput("./day11-input.txt")));
...
console.log("Part2");
console.log(part2(getInput("./day11-input.txt")));
