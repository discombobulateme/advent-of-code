...
represented as binary with the most significant bit first.
...
represent an operator that performs some calculation on one or more sub-packets
contained within. Right now, the specific operations aren't important;
...
The bit labeled I (0) is the length type ID,
which indicates that the length is a 15-bit number representing the number of
bits in the sub-packets.
The 15 bits labeled L (000000000011011) contain the length of the sub-packets in bits, 27.
The 11 bits labeled A contain the first sub-packet, a literal value representing the number 10.
The 16 bits labeled B contain the second sub-packet, a literal value representing the number 20.
After reading 11 and 16 bits of sub-packet data,
the total length indicated in L (27) is reached, and so parsing of this packet stops.
...
The 11 bits labeled B contain the second sub-packet,
a literal value representing the number 2.
The 11 bits labeled C contain the third sub-packet,
a literal value representing the number 3.
...
operator packet that contains an operator packet that contains five literal values;
...
--- Part Two ---
Now that you have the structure of your transmission decoded,
you can calculate the value of the expression it represents.
...
their value is 1 if the value of the first sub-packet
...
their value is 1 if the value of the first sub-packet is equal to the value of
...
Expected output: 911945136934
*/

//Resolution based on: https://github.com/TilenPogacnik/advent-of-code-2021/blob/main/Day16/solution.js
...
const input = fs.readFileSync("./day16-input.txt").toString('utf-8');
