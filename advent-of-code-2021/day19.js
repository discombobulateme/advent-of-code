...
beacons and scanners into the water.
...
three axes (x, y, and z) have their precise position determined relative to the scanner.
...
beacons at -500,1000,-1500 and 1501,0,-500,
...
relative to itself, the scanners do not know their own position.
...
This region can be reconstructed by finding pairs of scanners that have overlapping
detection regions such that there are at least 12 beacons that both scanners
detect within the overlap.
...
-5,0
-2,1
Drawing x increasing rightward, y increasing upward, scanners as S, and beacons as B,
...
That is, one scanner might call a direction positive x, while another scanner
might call that direction negative y. Or, two scanners might agree on which
direction is positive x, but one scanner might be upside-down from the
perspective of the other scanner.
...
(relative to scanner 0) and scanner 3 must be at -92,-2380,-20 (relative to scanner 0).
...
the largest Manhattan distance apart.
In total, they are 1197 + 1175 + 1249 = 3621 units apart.

What is the largest Manhattan distance between any two scanners?

Expected output: 13354
*/

// Resolution based on: https://github.com/joeyemerson/aoc/blob/main/2021/19-beacon-scanner/solution.js
