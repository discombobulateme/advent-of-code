...
Each step specifies a cuboid (the set of all cubes that have coordinates which
fall within ranges for x, y, and z) and whether to turn all of the cubes
in that cuboid on or off.
...
overlaps with the first. As a result, only 19 additional cubes turn on;
...
Expected output: 1302784472088899
*/

//Resolution based on: https://github.com/constb/aoc2021/blob/master/22/index.js

let data = require("fs").readFileSync("day22-input.txt", { encoding: "utf-8" }).trim();
