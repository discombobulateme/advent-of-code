...
Perhaps you can combine an image enhancement algorithm and the input image
(your puzzle input) to clean it up a little.
...
It is normally given on a single line, but it has been wrapped to multiple lines
in this example for legibility. The second section is the input image,
...
pixels centered on the corresponding input image pixel.
...
pixel of the input image, the nine pixels marked by [...] would need to be considered:
...
then #.., then .#.; combining these forms ...#...#..
...
can be found: #. So, the output pixel in the center of the output image should
be #, a light pixel.
...
Expected output: 17325

*/

// Resolution based on: https://github.com/tpatel/advent-of-code-2021/blob/main/day20.js
// Walk through: https://www.youtube.com/watch?v=1GrRShOr82Y

const fs = require("fs");

const [algorithm, data] = fs
  .readFileSync("day20-input.txt", { encoding: "utf-8" }) // read day??.txt content
