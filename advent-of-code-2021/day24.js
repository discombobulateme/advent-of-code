...
exactly once in order from top to bottom.
...
crash and might even damage the ALU.
...
in order of most to least significant.
(So, to check the model number 13579246899999, you would give 1 to the first
inp instruction, 3 to the second inp instruction, 5 to the third inp instruction,
...
Expected output: 99598963999971
...
Expected output:93151411711211
*/

//Resolution: https://github.com/constb/aoc2021/blob/master/24/index.js

let data = require("fs").readFileSync("day24-input.txt", { encoding: "utf-8" }).trim();
